...
declare type CreateOperationData = FormCreateData<Omit<OpSchema, "userId" | "applicationId"> & ({
...
declare type UpdateOperationData = FormUpdateData<Omit<OpSchema, "userId" | "applicationId">> & ({

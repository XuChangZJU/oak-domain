...
declare type CreateOperationData = Omit<OpSchema, "applicationId" | "userId" | "playerId" | "entityId"> & ({
    entity: "mobile";
    entityId: String<64>;
    mobile?: undefined;
} | ({
...
declare type UpdateOperationData = Partial<Omit<OpSchema, "id" | "applicationId" | "userId" | "playerId" | "entityId">> & ({
    entity?: "mobile";
    entityId?: String<64>;
    mobile?: undefined;
} | ({

import { String, Text, Datetime, PrimaryKey, ForeignKey } from "../../types/DataType";
...
declare type CreateOperationData = Omit<OpSchema, "systemId"> & ({
...
declare type UpdateOperationData = Partial<Omit<OpSchema, "id" | "systemId">> & ({

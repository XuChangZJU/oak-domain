...
var SimpleConnector = /** @class */ (function () {
    function SimpleConnector(option, makeException) {
        this.option = option;
        ...
        this.serverSubscribePointUrl = "".concat(serverUrl).concat(SimpleConnector.SUBSCRIBE_POINT_ROUTER);
    ...
    SimpleConnector.prototype.getSubscribePointRouter = function () {
    ...
    SimpleConnector.prototype.getSubscribePoint = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, global.fetch(this.serverSubscribePointUrl)];
                    case 1:
                        response = _b.sent();
                        if (response.status > 299) {
                            err = new types_1.OakExternalException("\u7F51\u7EDC\u8BF7\u6C42\u8FD4\u56DE\u5F02\u5E38\uFF0Cstatus\u662F".concat(response.status));
    ...
    SimpleConnector.prototype.parseRequestHeaders = function (headers) {
    ...
    SimpleConnector.prototype.serializeResult = function (result, opRecords, headers, body, message) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    SimpleConnector.SUBSCRIBE_POINT_ROUTER = '/subscribePoint';

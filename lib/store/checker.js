    ...
    var _loop_9 = function (entity) {
        ...
        checkers.push({
            ...
            checker: function (data) {
                var illegalNullAttrs = (0, lodash_1.difference)(notNullAttrs, Object.keys(data));
                if (illegalNullAttrs.length > 0) {
                    throw new Exception_1.OakAttrNotNullException(entity, illegalNullAttrs);
                }
                for (var attr in data) {
                    if (attributes[attr]) {
                        var _a = attributes[attr], type = _a.type, params = _a.params, defaultValue = _a.default, enumeration = _a.enumeration;
                        switch (type) {
                            case 'char':
                            case 'varchar': {
                            ...
                            case 'money': {
                                ...
                                var _b = params, min = _b.min, max = _b.max;

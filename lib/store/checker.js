                ...
                var checkData = function (data2) {
                    ...
                    if (illegalNullAttrs.length > 0) {
                        try {
                            ...
                            for (var illegalNullAttrs_1 = (e_8 = void 0, tslib_1.__values(illegalNullAttrs)), illegalNullAttrs_1_1 = illegalNullAttrs_1.next(); !illegalNullAttrs_1_1.done; illegalNullAttrs_1_1 = illegalNullAttrs_1.next()) {
                                ...
                                if (attr === 'entityId') {
                                    ...
                                    try {
                                        for (var _c = (e_9 = void 0, tslib_1.__values(attributes[attr].ref)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                            var ref = _d.value;

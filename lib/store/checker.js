                ...
                checkers.push({
                    ...
                    expression: function (operation, context) {
                        ...
                        var makeFilterFromRows = function (rows) {
                            ...
                            var legalRelationss = relations.map(function (ele) {
                                if (reverseHierarchy_1[ele]) {
                                    return reverseHierarchy_1[ele];
                                }
                                (0, assert_1.default)(false, "\u5728\u56DE\u6536".concat(userEntityName_1, "\u4E0A\u7C7B\u578B\u4E3A").concat(ele, "\u7684\u6743\u9650\u65F6\uFF0C\u627E\u4E0D\u5230\u5BF9\u5E94\u7684\u5B9A\u4E49\uFF0C\u4E0D\u5E94\u8BE5\u51FA\u73B0\u7684\u60C5\u51B5"));
                            });
                            // 如果要删除多个不同的权限，这里必须要有它们共同的上级权限
                            var legaRelations = (0, lodash_1.intersection)(legalRelationss);
                            return {
                                entity: userEntityName_1,
                                expr: {
                                    $gt: [{

        ...
        var _loop_1 = function (attr) {
            ...
            if (relation === 1 || relation == 0) {
                ...
                if (supportMtoJoin) {
                    ...
                    cascadeSelectionFns.push(function (result) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var dealWithSubRows, entityIds, subRows;
                        return tslib_1.__generator(this, function (_a) {
                            dealWithSubRows = function (subRows) {
                            ...
                            subRows = cascadeSelect.call(this, attr, {
                                data: projection2[attr],
                                filter: {
                                    id: {
                                        $in: entityIds
                            ...
                            if (subRows instanceof Promise) {
                                return [2 /*return*/, subRows.then(function (subRowss) { return dealWithSubRows(subRowss); })];
                            }
                            else {
                ...
                if (supportMtoJoin) {
                    ...
                    cascadeSelectionFns.push(function (result) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var dealWithSubRows, ids, subRows;
                        return tslib_1.__generator(this, function (_a) {
                            dealWithSubRows = function (subRows) {
                            ...
                            subRows = cascadeSelect.call(this, relation, {
                                data: projection2[attr],
                                filter: {
                                    id: {
                                        $in: ids
                ...
                if (foreignKey_1) {
                    ...
                    // 基于entity的多对一
                    cascadeSelectionFns.push(function (result) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var ids, dealWithSubRows, subRows;
                        return tslib_1.__generator(this, function (_a) {
                            ...
                            subRows = cascadeSelect.call(this, entity2_1, {
                                data: subProjection_1,

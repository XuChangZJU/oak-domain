...
var CascadeStore = /** @class */ (function (_super) {
    ...
    CascadeStore.prototype.cascadeSelect = function (entity, selection, context, params) {
     ...
     * @param params
     */
    CascadeStore.prototype.cascadeUpdate = function (entity, operation, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                            ...
                            return __generator(this, function (_p) {
                                switch (_p.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this_1.cascadeUpdate(attr, operationMto, context, params)];
                                    case 2:
                                        result2 = _p.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, this_1.cascadeUpdate(relation, operationMto, context, params)];
                                    case 4:
                                        result2 = _p.sent();
                                        this_1.mergeOperationResult(result, result2);
                                        return [3 /*break*/, 16];
                                            ...
                                            return __generator(this, function (_e) {
                                                switch (_e.label) {
                                                    case 0:
                                                        ...
                                                        return [4 /*yield*/, this.cascadeUpdate(entityOtm_1, otm, context, params)];
                                                    case 1:
                                                        result2 = _e.sent();
                                                        this.mergeOperationResult(result, result2);
                                                        return [2 /*return*/];
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, this.updateAbjointRow(entity, operation2, context, params)];
                    case 14:
                        count = _f.sent();

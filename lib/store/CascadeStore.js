...
var CascadeStore = /** @class */ (function (_super) {
    ...
    CascadeStore.prototype.doUpdateSingleRow = function (entity, operation, context, option) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var data, action, operId, filter, now, _a, modiCreate, addTimestamp_1, result_1, createInner, multipleCreate, data_2, data_2_1, d, createSingleOper, e_4_1, operatorId, createOper, _b, ids_1, selection, rows, modiUpsert, upsertModis, _c, originData, originId, createOper, updateAttrCount, result;
                ...
                switch (_o.label) {
                    ...
                    case 1:
                        if (data instanceof Array) {
                            data.forEach(function (ele) { return _this.preProcessDataCreated(entity, ele); });
                        }
                        else {

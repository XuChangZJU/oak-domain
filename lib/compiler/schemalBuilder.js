...
function registerSelectFreeEntities(entities) {
    SELECT_FREE_ENTITIES = entities;
}
exports.registerSelectFreeEntities = registerSelectFreeEntities;
...
function outputRelation(outputDir, printer) {
    ...
    var stmts = [
        factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([
            ...
            factory.createImportSpecifier(false, undefined, factory.createIdentifier("SelectFreeEntities"))
    ...
    stmts.push(factory.createVariableStatement([
        factory.createToken(ts.SyntaxKind.ExportKeyword)
    ], factory.createVariableDeclarationList([factory.createVariableDeclaration(factory.createIdentifier("selectFreeEntities"), undefined, factory.createTypeReferenceNode(factory.createIdentifier("SelectFreeEntities"), [factory.createTypeReferenceNode(factory.createIdentifier("EntityDict"), undefined)]), factory.createArrayLiteralExpression(SELECT_FREE_ENTITIES.map(function (ele) { return factory.createStringLiteral(ele); }), false))], ts.NodeFlags.Const)));

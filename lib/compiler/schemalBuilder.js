...
function addActionSource(moduleName, name, node) {
    ...
    (0, lodash_1.assign)(ast.importedFrom, {
        [name.text]: (0, env_1.ACTION_CONSTANT_IN_OAK_DOMAIN)(),
    });
}
...
function constructActions(statements, entity) {
    ...
    statements.push(factory.createTypeAliasDeclaration(undefined, [factory.createModifier(ts.SyntaxKind.ExportKeyword)], factory.createIdentifier("CreateOperationData"), undefined, factory.createTypeReferenceNode(factory.createIdentifier("FormCreateData"), [

...
const ActionImportStatements = () => [
    factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([factory.createImportSpecifier(false, undefined, factory.createIdentifier("ActionDef"))])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}Action`), undefined),
    factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([factory.createImportSpecifier(false, undefined, factory.createIdentifier("GenericAction"))])), factory.createStringLiteral((0, env_1.ACTION_CONSTANT_IN_OAK_DOMAIN)(2)), undefined)
];
const ActionAsts = {};
...
function addActionSource(moduleName, name, node) {
    ...
    (0, assert_1.default)(ts.isStringLiteral(moduleSpecifier) &&
        (moduleSpecifier.text === (0, env_1.ACTION_CONSTANT_IN_OAK_DOMAIN)(1)
            || (EntitiesInOakDomain.includes(moduleName) && moduleSpecifier.text === '../actions/action')));
    (0, lodash_1.assign)(ast.importedFrom, {
        [name.text]: (0, env_1.ACTION_CONSTANT_IN_OAK_DOMAIN)(2),
    });
}
...
function getEntityImported(declaration, filename) {
    ...
    if (ts.isStringLiteral(moduleSpecifier)) {
        ...
        else if (moduleSpecifier.text.startsWith((0, env_1.ENTITY_PATH_IN_OAK_DOMAIN)()) && !process.env.COMPILING_BASE_DOMAIN) {
        ...
        if (ts.isTypeReferenceNode(type)) {
            ...
            if (ts.isIdentifier(typeName)) {
                ...
                if (manyToOneItem) {
                    ...
                    members.push(factory.createPropertySignature(undefined, factory.createIdentifier(foreignKey), questionToken, factory.createTypeReferenceNode(factory.createIdentifier('ForeignKey'), [
...
const initialStatements = () => [
    ...
    ])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}DataType`)),
    /* import {
    ...
    ])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}Demand`)),
    factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([
    ...
    ])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}Polyfill`)),
    ...
    ])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}Entity`), undefined)
];
...
function outputSchema(outputDir, printer) {
    for (const entity in Schema) {
        ...
        if (ActionAsts[entity]) {
            ...
            statements.push(factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([factory.createImportSpecifier(false, undefined, factory.createIdentifier("GenericAction"))])), factory.createStringLiteral((0, env_1.ACTION_CONSTANT_IN_OAK_DOMAIN)(2)), undefined));
        }
...
function outputStorage(outputDir, printer) {
    ...
    for (const entity in Schema) {
        ...
        const statements = [
            factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([factory.createImportSpecifier(false, undefined, factory.createIdentifier("StorageDesc"))])), factory.createStringLiteral(`${(0, env_1.TYPE_PATH_IN_OAK_DOMAIN)(2)}Storage`), undefined),
